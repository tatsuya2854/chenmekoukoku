...
| 4 | 4.6–6.4 | 1.8 | **手のひらでクリームを合わせる**マクロ。指の間に伸びる | SE：手と手の「くちゅ」（小さく） | なし | 白さが飛ばないよう −0.3EV |
| 5 | 6.4–9.6 | 3.2 | **ふくらはぎ**、膝→足首→膝。両手で包み、親指でゆっくり。60fps→24 スロー 60% | SE：肌をなでる音。BGM −22dB | なし | 1 往復。手の動きは"円"を描く。**強く押さない** |
